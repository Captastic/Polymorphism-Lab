...
public class Engine {
    ...
    public void run(){
        ...
        input_output.printListOfPets(petWarehouse.sortListByName(petWarehouse.getPets()));
        input_output.printListOfPets(petWarehouse.sortListByType(petWarehouse.getPets()));
    }
